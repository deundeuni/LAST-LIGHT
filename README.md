# LAST-LIGHT — Technical Specification for Auxiliary Wayfinding System via Standard Illuminated Signs, Internal/External Fire Cabinets, Smart Raceways, and Multi-Sensory Acoustic/Haptic Infrastructure (Ver. 3.6)

> **Document Classification:** Defensive Publication / Prior Art Technical Specification  
> **Initial Conception Date:** July 30, 2026 / **Final Revision Date (v3.6):** August 30, 2026  
...
This core intent led to a field-driven technical intuition: **"Can standard exit signage (pictograms) affixed to building walls serve as absolute visual references for smartphones, robots, and AR glasses during disasters?"** and **"Can multi-spectrum optical modules, directional acoustic emitters, and bone-conduction tactile interfaces placed within fire hose cabinets, alarm terminal boxes, and along ceiling raceways act as active survival anchors under complete zero-visibility conditions for both civilians and emergency responders?"**

Existing emergency lightings remain passive markers, while GPS and Wi-Fi positioning suffer from severe signal attenuation and drift in indoor or blackout environments. By establishing permanently illuminated exit signs, internal/external fire service cabinets, underground electrical raceways, and spatial sound anchors as **Visual/Optical/Acoustic Absolute Anchors (ANCHOR)**, this system provides high-visibility green guidance and 3D directional spatial audio for civilians, alongside high-contrast infrared (IR) signal pathways and bone-conduction haptic feedback for first responders.

### 0.2 Master Concept & Sensor Fusion Standard
The visual/optical/acoustic ANCHOR-based zero-point calibration and offset correction mechanism disclosed in this specification serves as the **Master Reference Framework** for the overall positioning and wayfinding system.

Any additional integration of secondary positioning or sensing modalities—including gyroscopes, accelerometers, Inertial Measurement Units (IMUs), microphone arrays, acoustic/ultrasonic transducers, bone-conduction actuators, LiDAR, Time-of-Flight (ToF) sensors, thermal imaging, Ultra-Wideband (UWB), and infrared sensors—whether applied individually or in combination, constitutes a subordinate combination that relies on this master zero-point calibration. All such sensor fusion implementations fall entirely within the scope of this prior art.
...
This architecture is not proprietary to any specific optical camera, vision sensor, microphone array, bone-conduction headset, LiDAR, mobile device, or robotic framework. It operates as an Open Public Standard capable of utilizing all public-domain illuminated signs (e.g., ISO 7010 series), fire service cabinet indicators (internal/external), directional sound anchors, and ceiling raceway optical anchors as reference points.
...
This architecture comprehensively applies to smartphone-based pedestrian evacuation applications, autonomous mobile robot (AMR) relocation modules, smart emergency lighting/acoustic anchors, internal/external fire cabinet anchors, underground raceway multi-spectrum anchors, disaster relief AR glasses, firefighter NVG equipment, and bone-conduction haptic rescue headsets.
...
While this architecture was independently conceived and formulated by the inventor, it does not exclude the possibility that similar concepts regarding visual or acoustic reference utilization were independently developed by other researchers or entities. The primary objective of this publication is not to claim exclusive monopoly, but to record this intuitive framework as public prior art, preventing private monopolization and allowing public access for safety implementation.
...
* **v3.5 (2026-08-30)** — Integration of internal fire cabinet chamber/cover deployment and 3D high-survival optical anchor network specifications (3.A).
* **v3.6 (2026-08-30)** — [Final] Full integration of zero-visibility spatial audio anchors, microphone arrays, bone-conduction haptic interfaces, and multi-sensory directional guidance (3.A, 3.B).

---

## 2. Full-Stack Applied Architecture (3-Tier Applied Architecture)

* **[L2] Auxiliary Guidance & Specialized UI Layer:** Civilian green visual & spatial audio guidance, firefighter/first-responder IR/NVG high-contrast overlay, bone-conduction tactile vibration cues, AR/voice wayfinding assistance, and telemetry backhaul.
* **[L1] Perception & Estimation Fabric:** Multi-spectrum (visible/IR) feature extraction modules, microphone array Direction of Arrival (DOA) & acoustic signal processing modules, estimation filtering algorithms (EKF, Doppler/phase probabilistic models), sensor fusion engines (gyro/IMU/acoustic/LiDAR), AI state estimators, self-healing mesh networking, and confidence verification modules.
* **[L0] Infrastructure & Optical/Acoustic Layer:** ISO 7010 emergency signage, fire hose cabinet/alarm terminal box internal & external status indicators (red/multi-spectrum LED) & directional sound emitters, ceiling raceway multi-spectrum/acoustic emitters, bone-conduction transducers, microphone arrays, emergency power interfaces, and non-contact sensors.
...
* **Core AI Functions:**
  * **Multi-Spectrum & Spatial Acoustic Perception:** Asynchronously isolates ISO 7010 pictograms, internal/external fire cabinet indicators, raceway IR/visible emitters, and acoustic anchor frequencies amidst dense smoke, ambient fire noise, and backlight distortion.
  ...
  * **Confidence Control & Adaptive Signal Generation:** Suppresses hallucinated guidance when perception confidence drops below thresholds, and independently generates tailored multi-sensory guidance (visible/spatial audio for civilians, IR/NVG/bone-conduction tactile vibrations for first responders).

---

## 3. Core System Blocks and Mechanisms

* **A. ANCHOR Signage, Internal/External Fire Cabinets, Acoustic Anchors & Raceway Sensing Unit (Absolute Reference Infrastructure):**
  * ISO 7010 standard emergency signs, building fire hose cabinets, alarm terminal boxes, power control panels (surface status LEDs, housing geometry, internal protective chambers, inner door surfaces, and translucent windows), ceiling raceways, and **directional audio speakers / spatial sound anchors (Acoustic Anchors)** act as absolute spatial reference nodes (ANCHOR).
  * Under zero-visibility dense smoke environments, directional spatial audio, ultrasonic pulses, and frequency-modulated acoustic signals emitted from ANCHOR nodes provide auditory zero-point calibration.
  * Transmits specialized multi-channel guidance to first responders via **bone-conduction tactile vibration signals and high-penetration acoustic frequencies**, ensuring clear directionality even in deafening fireground environments.
  * Operates via non-contact optical and acoustic reception without requiring electrical or physical modifications to existing legacy infrastructure.

* **B. ESTIMATION & Multi-Sensory Auxiliary Guidance Unit (Estimation & Processing):**
  * **Feature Extraction:** Extracts ISO pictogram geometries, internal/external fire cabinet status indicators, raceway multi-spectrum corner points, and acoustic phase/delay/DOA (Direction of Arrival) spectrogram features from optical camera and microphone array feeds.
  * **Estimation Algorithm (Input / Process / Output):**
    * **Input:** Relative movement vectors from IMU/gyroscope/LiDAR/acoustic sensors, optical ANCHOR features, and acoustic phase/DOA observations.
    ...
    * **Output:** 3D spatial state coordinates with error covariance matrices, alongside synchronized visual, spatial audio, and bone-conduction haptic direction signals (e.g., directional audio prompts and localized tactile vibrations indicating "Exit 3m Left" or "Fire Cabinet Anchor Ahead").
...
* **D. Self-Healing Multi-Mesh & Zero-Downtime Fail-Over:**
  ...
  2. **Dynamic Self-Healing:** Upon physical destruction of any node, the mesh isolates the failed node within 100ms and reroutes communication, compute, and acoustic signal transmission around the failure point.
  3. **Zero-Downtime Fail-Over:** Adjacent functional nodes autonomously assume spatial calculation, optical emission, and spatial audio/haptic rendering tasks of destroyed units, ensuring uninterrupted wayfinding execution.

---

## 4. Dynamic Resource Management & Defensive Safety Control

* **Rate Limiter:** Dynamically caps frame and audio packet intake rates to prevent processor saturation under excessive visual or acoustic inputs.
* **Random Sampling Scan:** Asynchronously samples ambient lighting and acoustic noise variations to isolate smoke, glare, and fire noise into sandboxed buffers.
* **Relocation Interception:** Blocks offset correction routines if unauthorized glare, reflections, or spoofed acoustic/optical points are detected.
...
* **Standards Compliance:** Conforms to ISO 7010, ISO 16069, statutory fire safety optical conventions, and acoustic signaling standards without claiming exclusive proprietary rights over international standards.
...
* **Physical Operational Limits:** Acknowledges that extreme smoke density or deafening acoustic noise may degrade sensory line-of-sight; primary evacuation responsibility remains with statutory systems and fire authority personnel.

---

## 6. Industrial Applicability and Future Extensions

* **Smart Underground Raceway Visual/Acoustic Anchors:** Multi-spectrum emitter and directional audio deployment on ceiling raceways for autonomous parking robot calibration and emergency first-responder guidance.
* **Internal/External Fire Cabinet 3D Spatial Anchors:** Utilization of fire hose cabinet status lights, internal chamber modules, and acoustic beacons as zero-point reference nodes in zero-visibility corridors.
* **Smart Building AR, NVG & Bone-Conduction Navigation:** 3D spatial overlay projection and tactile bone-conduction haptic feedback for AR glasses, NVG devices, and rescue headsets in complete blackout environments.
* **AMR Indoor Positioning:** Absolute offset correction for logistics robots operating in GPS-denied underground facilities via optical and acoustic anchor fusion.
* **Disaster Relief Robotics:** Vision and acoustic-guided anchor tracking for search-and-rescue robotics in hazardous structures.
...
* **Trade Secret Reservation:** Precise visual/acoustic feature extraction algorithms, directional audio phase parameters, and edge-AI NPU optimization weights are retained offline as confidential trade secrets.
...
All terms (ANCHOR, ESTIMATION, Master Reference, internal/external fire cabinet anchor, acoustic anchor, spatial audio, directional speaker, microphone array, bone conduction, sLLM/Edge AI, self-healing mesh, etc.) and numerical ranges represent non-limiting embodiments. Any functional equivalents, terminology substitutions, or structural rearrangements fall within the scope of this prior art.

### 7.4 Software-Defined Equivalents
All optical/acoustic processing, sensor fusion, mesh routing, and AI governance mechanisms may be equivalently implemented via edge-NPU firmware, virtualized software, or software-defined architectures without departing from the prior art scope.
...
* **v3.1 ~ v3.5 (2026-08-30):** Independent prior research (0.8), AI disclosure (Appendix C), emergency power (3.C), sensor fusion baseline (0.2), fire cabinet anchor specs (3.A), and internal chamber deployment.
* **v3.6 (2026-08-30):** Full integration of zero-visibility spatial audio anchors, microphone arrays, bone-conduction haptic interfaces, and multi-sensory directional guidance (3.A, 3.B).
...
* **Document Structuring & Expansion:** Gemini — Structural refinement, raceway/fire cabinet internal-external optics, spatial audio anchors, bone conduction, AI governance, emergency power integration, and master reference framework expansion.
