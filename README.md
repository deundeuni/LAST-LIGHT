> **Multilingual Notice:** This document is published in dual languages (Korean/English). v4.7 2026-09-09 (Korean version: [README.ko.md](README.ko.md))  
...
## Subtitle: Defensive Publication White Paper on 0-Point Calibration, Multisensory Haptics, and Blackbox Infrastructure via ISO 7010 Signage, Hydrant Boxes, Smart Raceways, Orbital Modules, and AR Glasses/Smart Ring/Robotics Infrastructure (Ver. 4.7)

* **Official Document Classification:** Defensive Publication / Prior Art White Paper
* **Initial Conception Date:** 2026-07-30 / **Final Revision Date (v4.7):** 2026-09-09
...
* **v4.3 ~ v4.6 (2026-09-09):** Extended to heterogeneous multi-devices, SLAM timescale refined, underground telecom (small cell/DAS) auxiliary integration and offline-first hierarchy established, and fire-rated infrastructure non-obviousness logic applied.
* **v4.7 (2026-09-09):** **[Compression of Fire-Rated Grounds & Specification Separation]** Unified non-obvious selection grounds in Section 0.2 and compressed redundant descriptions in Sections 3.A and 3.H via cross-references. Differentiated regulatory grounds for ground hydrant boxes (domestic NFPC, etc.) and space module chambers (spacecraft structural safety standards, etc.) in Section 3.H. Corrected terminology in Section 6 to maintain 1:1 fidelity with the Korean original.
